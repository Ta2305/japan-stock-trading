...
class LongOnlySwingSimulator:
    ...
    def step(self, date: str, daily_prices: Dict[str, Dict[str, float]], buy_signals: List[str]):
...
def main():
    ...
    sim = LongOnlySwingSimulator(initial_cash=1_000_000.0, max_positions=5, allow_fractional=True)
    ...
    print("=========================================================================")
    print("   STRATEGY 01: LONG ONLY SWING (2026 OUT-OF-SAMPLE BACKTEST)")
    print("=========================================================================")
